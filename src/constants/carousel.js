...
export const Carousel = [
  ...
  {
    imagePath: require('../assets/images/store.png'),
  ...
  {
    imagePath: require('../assets/images/choose plant.png'),
  ...
  {
    imagePath: require('../assets/images/delivery to your door.png'),
  ...
  {
    imagePath: require('../assets/images/get support.png'),
